function [minthis] = sir_nyc_obj_wrapper_maxfree_doh(x)
...
studyTindx = realT > datetime('4/12/2020','InputFormat','MM/dd/yyyy') & ...
    realT < datetime('4/19/2020','InputFormat','MM/dd/yyyy');
MSEstudy2 = mean( (0.21 - mean(i(studyTindx)+r(studyTindx))).^2 );
